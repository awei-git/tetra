...
Start here if you are setting up the local stack.

- quickstart.md: end-to-end setup for local usage
- database.md: database layout and initialization
- pipelines.md: ingestion pipelines and automation
